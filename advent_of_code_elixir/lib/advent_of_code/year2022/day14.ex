defmodule AdventOfCode.Year2022.Day14 do
  ...
  def run(input_file_name) do
    ...
    print_image(part1_state, obstacles, "priv/outputs/2022_day14_part1_output.txt")

    part2_state = pour_sand(obstacles, @origin, max_y + 1, false)
    part2 = MapSet.size(part2_state) - MapSet.size(obstacles)
    print_image(part2_state, obstacles, "priv/outputs/2022_day14_part2_output.txt")

    {part1, part2}
  end

  def load_input(input_file_name) do
    File.read!("priv/inputs/2022/day14/#{input_file_name}.txt")
